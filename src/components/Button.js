...
export const AppoinmentButton = ({text,extraClass='', children}) => {
    return (
        <a className={`appoinment-general-button ${extraClass}`} target="_blank"
         href="https://api.whatsapp.com/send?phone=6646706182" data-action="share/whatsapp/share" rel="noreferrer">{children}{text}</a>
    )
}
